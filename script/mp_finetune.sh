...
n_gpu=4
n_cpu=24
task="finetune abcn gy 5ep lr001 `date "+%Y-%m-%d %X"`"
...
# -m 10240
falcon submit   -g "${n_gpu}" -c "${n_cpu}" -n "${task}"  -m 10240 -r  /home/notebook/code/personal/appseq/src/finetune_abcn_mp_gy.py
