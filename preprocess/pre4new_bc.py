...
def clean_sp_data(file, sub_idx):
    print(file)
    if file=="/home/notebook/data/group/app-series/pretrain_game/xaa":
...
if __name__=='__main__':
    data_path = "/home/notebook/data/group/app-series/pretrain_game/"
    ...
    # for i in range(15,len(open_files)):
    #     in_file = open_files[i]
    #     out_file = data_path + "preprocess/gb_{}.pickle".format(i)
    #     print(in_file)
    #     gather_open(in_file, out_file)
    pickle_files = glob.glob(data_path + "preprocess/gb*")
    pickle_all_file = data_path + "preprocess/open_data.pkl"
    ...
    #     in_file = open_files[i]
        # out_file = "/home/notebook/data/group/app-series/pretrain/app_2207_h_{}.csv".format(i)
        # filter_time(in_file, in_file)
        #if i == 3:
        #    time.sleep(7200) # wait for clean_sp_data...

    # for i in range(10,len(open_files)):
    #     in_file = open_files[i]
    #     out_file = data_path + "preprocess/bc_{}".format(i)
    #     print(out_file)
    ...
    ae_file = data_path+"/un_in_clean.csv"
    # df = pd.read_csv(data_path+"/un_in_clean.csv", sep='\t', nrows=5)
    # print(df)
    # print(df.columns)
