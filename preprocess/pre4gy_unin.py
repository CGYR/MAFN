...
def merge_all(files, tgt_file):
    ...
    out_df.fillna("unk", inplace=True)
    # attr_file = '/home/notebook/data/group/app-series/pretrain_game/shixu_20230307_quzd_yuren.csv'
...
if __name__=="__main__":
    ...
    tgt_dir = dir + "gy202303/"
    ins_files = glob.glob(dir + "*_install*gy*")
    uns_files = glob.glob(dir + "*_uninstall*gy*")
