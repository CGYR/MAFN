...
def clean_sp_data(file, sub_idx):
    print(file)
    if file=="/home/notebook/data/group/intention_rec/app-series/pretrain_game/gy_open/xaa":
...
def filter_user_process(input):
    ...
    for i in range(len(imei_list)):
        ...
        if len(use_pack_list) < 5: # filter cold user
            use_pack_list = ["unk"]
            use_time_list = ["2023-03-01 00:00:00"]
...
def merge_sp_ae_bc(ae_file, bc_files, tgt_path, sp_num):
    ...
    df = pd.merge(df_ae, df_bc, on="imei", how="left")
...
def merge_embs(emb_files, tgt_file):
    df = pd.DataFrame()
...
if __name__=='__main__':
    data_path = "/home/notebook/data/group/intention_rec/app-series/pretrain_game/gy_open/"
    ...
    # ae_file = "/home/notebook/data/group/intention_rec/app-series/pretrain_game/gy202303/un_in_forecast_clean.csv"
    
    # merge_sp_ae_bc(ae_file, open_files, data_path, 4)

    # NOTE repeat process, for 0301~0307
    # open_files = glob.glob(data_path + "shixu_oppo_20230320_imei_gy_train_2023*")
    ...
    #     part = file[-8:]
    #     ae_file = "/home/notebook/data/group/intention_rec/app-series/pretrain_game/gy202303/un_in_2023{}".format(part)
    #     merge_ae_bc(ae_file, file, data_path + "abcn_day_{}".format(part))

    # merge forecast embs
    sum_files = ["/home/notebook/data/group/intention_rec/app-series/pretrain_game/gy_open/imei_embs_sum_fine_{}.csv".format(i) for i in range(4)]
    # ae_files = ["/home/notebook/data/group/intention_rec/app-series/pretrain_game/gy_open/imei_embs_ae_last_{}.csv".format(i) for i in range(4)]
    
    merge_embs(sum_files, "/home/notebook/data/group/intention_rec/app-series/pretrain_game/gy_open/imei_embs_sum_fine_forecast.csv")
    # merge_embs(ae_files, "/home/notebook/data/group/intention_rec/app-series/pretrain_game/gy_open/imei_embs_ae_last_forecast.csv")

    # # merge train embs
    # train_sum_files = ["/home/notebook/data/group/intention_rec/app-series/pretrain_game/gy_open/imei_embs_sum_fine_030{}.csv".format(i+1) for i in range(7)]
    # train_ae_files = ["/home/notebook/data/group/intention_rec/app-series/pretrain_game/gy_open/imei_embs_sum_last_030{}.csv".format(i+1) for i in range(7)]

    # merge_train_files(train_sum_files, "/home/notebook/data/group/intention_rec/app-series/pretrain_game/gy_open/imei_embs_sum_fine_train.csv")
    # merge_train_files(train_ae_files, "/home/notebook/data/group/intention_rec/app-series/pretrain_game/gy_open/imei_embs_ae_last_train.csv")
